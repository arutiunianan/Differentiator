...
dif: main.o tree.o dif.o tex.o
	g++ main.o tree.o dif.o tex.o -o main
...
tree.o: tree/tree.cpp
	g++ $(CFLAGS) -c tree/tree.cpp

dif.o: differentiator/dif.cpp
	g++ $(CFLAGS) -c differentiator/dif.cpp

tex.o: tex/tex.cpp
	g++ $(CFLAGS) -c tex/tex.cpp